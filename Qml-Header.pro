...
UBUNTU_TRANSLATION_DOMAIN="qml-header.larreamikel"
...
aptest.commands = bash $$PWD/Qml-Header/tests/autopilot/run
aptest.depends  = sub-Qml-Header

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Qml-Header/tests/unit 
unittest.depends  = sub-Qml-Header
